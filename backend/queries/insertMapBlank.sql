...
-- map_name - I'm not particularly doing anything with this at the moment.
-- degree - Should be the full value obtained from MAPS_ACAD_PLAN - EX CSCI should be "Computer Science".
-- start_year - Should be the format compatible with the database - either FA #### or SP ####.
...
SET @last_update_id = @submit_id;
SET @last_update_time = @submit_time;

INSERT INTO MAPS_DMAPS_META (map_name, degree, start_year, institute_id, submit_id, submit_time, last_update_id, last_update_time)
VALUES (@map_name, @degree, @start_year, @institute_id, @submit_id, @submit_time, @last_update_id, @last_update_time);

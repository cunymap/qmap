...
-- MAP_ID is generated by the insert statement.
-- For each Semester/Class variable, it would have to come from user input. 
...
VALUES (@map_name, @degree, @start_year, @institution_id, submit_id, @submit_time, @last_update, @last_update_time);

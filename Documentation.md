...
After completing the above steps, we are now ready to run the development server. I followed this [tutorial](https://www.django-rest-framework.org/tutorial/quickstart/). To run the server, navigate to the project directory (backend) and run the command:
